...
class Usuarios extends CI_Controller {
	...
	{	
		...
		set_tema('conteudo',load_modulo($this->view.'login'));
		set_tema('rodape','');
		load_template();
	}
	...
	{	
		...
		set_tema('conteudo',load_modulo($this->view.'gerenciar',array('data'=>$query)));
		load_template();
	}
	...
	public function alterar_senha()
	{
		...
		set_tema('conteudo',load_modulo($this->view.'editar','alterar_senha'));
		load_template();		
	}
