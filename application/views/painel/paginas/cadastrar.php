	<div class="small-9 large-9 columns row left">
		...
		<h3 class="blue-title">Adicionar Nova pagina</h3>		
		<?php				
		echo form_open('paginas/cadastrar',array('class'=>'custom','enctype' =>'multipart/form-data'));
		...
		<div class="row collapse prefix-radius">
	        ...
	        <div class="small-10 columns">
	          <?php echo form_input(array('name'=>'titulo'), set_value('titulo'),'autofocus');  ?>
	        </div>
	     </div>
