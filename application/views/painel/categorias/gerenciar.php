				      ...
				      <select name="cod_hierarquia">
				      	...
				      	<?php if (isset($categorias)){?>
					      	<?php foreach ($categorias as $data) { ?>
					      		<option value="<?php echo $data->id_categoria; ?>"><?php echo $data->nome ?></option>
					      	<?php } ?>				      	
				      	<?php } ?>
				      </select>					      							      		
			      </label>
					...
					foreach ($categorias as $data) 
					{
						...
						printf('<td class="td-title-main">%s</td>','<strong><a href="">'.$data->nome.'</a></strong>'.							
							'<span class="ation-table">'.
								anchor("categorias/editar/".$data->id_categoria,'Editar',array('title'=>'Editar')).
								anchor("categorias/excluir/".$data->id_categoria,'Excluir',array('title'=>'Excluir')).
							'</span>'
						);
